...
def _load_rcmed_dataset_object(dataset_info, eval_bounds):
    ...
    dataset = rcmed.parameter_dataset(int(dataset_info['dataset_id']),
                                      ...
                                      eval_bounds['lat_min'] - 1 if eval_bounds['lat_min'] < 0 else eval_bounds['lat_min'] + 1,
                                      eval_bounds['lat_max'] - 1 if eval_bounds['lat_max'] < 0 else eval_bounds['lat_max'] + 1,
                                      eval_bounds['lon_min'] - 1 if eval_bounds['lon_min'] < 0 else eval_bounds['lon_min'] + 1,
                                      eval_bounds['lon_max'] - 1 if eval_bounds['lon_max'] < 0 else eval_bounds['lon_max'] + 1,
